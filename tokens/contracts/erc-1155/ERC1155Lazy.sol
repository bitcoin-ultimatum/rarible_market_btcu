...
abstract contract ERC1155Lazy is IERC1155LazyMint, ERC1155BaseURI, Mint1155Validator, RoyaltiesV2Upgradeable, RoyaltiesV2Impl {
    ...
    function mintHash(LibERC1155LazyMint.Mint1155Data memory data) external pure returns (bytes32) {
        return LibERC1155LazyMint.hash(data);
    }

    function mintHashToSign(LibERC1155LazyMint.Mint1155Data memory data) external pure returns (bytes32) {
        return LibERC1155LazyMint.hashToSign(data);
    }
